...
namespace Watermelon.BusStop
{
    public class TileManager : MonoBehaviour
    {
        ...
        {
            cellPool = new PoolGeneric<Transform>(data.CellPrefab, "Tile_Cell");
            borderPool = new PoolGeneric<Transform>(data.BorderPrefab, "Tile_Border");
            outerCornerPool = new PoolGeneric<Transform>(data.OuterCornerPrefab, "Tile_OuterCorner");
            innerCornerPool = new PoolGeneric<Transform>(data.InnerCornerPrefab, "Tile_InnerCorner");
        }

        public void Clear()
        {
            PoolManager.DestroyPool(cellPool);
            PoolManager.DestroyPool(borderPool);
            PoolManager.DestroyPool(outerCornerPool);
            PoolManager.DestroyPool(innerCornerPool);
        }
