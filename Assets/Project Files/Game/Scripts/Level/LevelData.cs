...
namespace Watermelon.BusStop
{
    ...
    public class LevelData : ScriptableObject
    {
        ...
        [SerializeField, LevelEditorSetting] SpawnerData[] spawnerData;
        public SpawnerData[] SpawnerData => spawnerData;

        [SerializeField, LevelEditorSetting] TutorialStep[] tutorialSteps;
        public TutorialStep[] TutorialSteps => tutorialSteps;

        [SerializeField, LevelEditorSetting] LevelElement.Type[] busSpawnQueue;
        public LevelElement.Type[] BusSpawnQueue => busSpawnQueue;

        [SerializeField, LevelEditorSetting] int width;
        public int Width => width;

        [SerializeField, LevelEditorSetting] int height;
        public int Height => height;

        [SerializeField, LevelEditorSetting] int coinsReward = 20;
        public int CoinsReward => coinsReward;

        [SerializeField, LevelEditorSetting] bool useInRandomizer = true;
