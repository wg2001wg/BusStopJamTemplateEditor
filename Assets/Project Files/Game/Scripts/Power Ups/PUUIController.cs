    ...
    public class PUUIController : MonoBehaviour
    {
        ...
        public void Init(PUController powerUpController)
        {
            ...
            for (int i = 0; i < activePowerUps.Length; i++)
            {
                ...
                uiBehaviors[i].Init(activePowerUps[i]);
            }
        ...
        {
            List<PUSettings> unlockedPowerUps = new List<PUSettings>();
            ...
            for (int i = 0; i < uiBehaviors.Length; i++)
            {
                if(uiBehaviors[i].Behavior.IsActive())
                {
                    ...
                    PUSettings settings = uiBehaviors[i].Settings;
            ...
            {
                PUUIUnlockPanel unlockPanel = PUUIUnlockPanel.Instance;
                if(unlockPanel != null)
                {
                    unlockPanel.Show(unlockedPowerUps);
                }
            }
        }
